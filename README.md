...
| 파트 | 주제 | 상태 |
|------|------|------|
| **파트1** | [통계적 언어 모델의 원리](https://www.honglab.ai/courses/llmpt1) | 출시 |
| **파트2** | 뉴럴 언어 모델<br>CPU 최적화 | 제작 중 |
| **파트3** | 트랜스포머<br>GPU 가속 | 준비 중 |
| **파트4** | 현대적 LLM | 계획 중 |
...
2차 저작물에는 참고자료에 "[홍정모 연구소](https://honglab.ai/)"를 꼭 적어주세요.

> 예시) [홍정모 연구소](https://honglab.ai/)의 "LLM 바닥부터 만들기"를 참고하였습니다.
